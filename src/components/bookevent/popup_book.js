...
const Popup = ({ seat_detail }) => {
    ...
    const totalAmount = ()=>{
       ...
       const normal = seat_detail?.price?.normal?seat_detail.price.normal:0
        ...
        return  (front *quantity.front +middle *quantity.middel + back*quantity.back + primium*quantity.primium + normal*quantity.normal)
        ...
        <>
            <div className="popup_main" id="popup_main">
                <div className="popup_close">
                    <p><FaWindowClose onClick={()=>{document.getElementById("popup").style.display="none";
